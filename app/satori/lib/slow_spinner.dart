...
@immutable
class SlowSpinner extends StatefulWidget {
  final Duration wait;
  final Color color;
  final double size;
  const SlowSpinner({
  ...
  _SlowSpinnerState createState() => _SlowSpinnerState();
}

class _SlowSpinnerState extends State<SlowSpinner>
    with TickerProviderStateMixin {
  final int durationV = 1236067 + 1000;
  final int durationH = 2000000 + 1000;
